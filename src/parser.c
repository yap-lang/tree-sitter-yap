...
enum ts_symbol_identifiers {
  ...
  sym_record = 17,
  sym_record_field = 18,
  aux_sym_access_repeat1 = 19,
  aux_sym_record_repeat1 = 20,
};
...
static bool ts_lex(TSLexer *lexer, TSStateId state) {
  ...
  switch (state) {
    ...
    case 17:
      ...
      if (set_contains(sym_identifier_character_set_2, 800, lookahead)) ADVANCE(17);
      END_STATE();
    default:
      return false;
  }
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [19] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_application, 2, 0, 2),
  [21] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_abstraction, 3, 0, 4),
  [23] = {.entry = {.count = 1, .reusable = true}}, SHIFT(2),
  [25] = {.entry = {.count = 1, .reusable = true}}, SHIFT(4),
  [27] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_access, 1, 0, 0),
  [29] = {.entry = {.count = 1, .reusable = false}}, SHIFT(28),
  [31] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_access, 2, 0, 3),
  [33] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_access_repeat1, 2, 0, 6),
  [35] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_access_repeat1, 2, 0, 6), SHIFT_REPEAT(28),
  [38] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_access_repeat1, 2, 0, 5),
  [40] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_access_repeat1, 2, 0, 5),
  [42] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_record, 2, 0, 0),
  [44] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_record, 3, 0, 0),
  ...
  [54] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_record_repeat1, 2, 0, 0), SHIFT_REPEAT(23),
  [57] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_record_repeat1, 2, 0, 0),
  [59] = {.entry = {.count = 1, .reusable = true}}, SHIFT(11),
  [61] = {.entry = {.count = 1, .reusable = true}}, SHIFT(12),
  [63] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_record_field, 4, 0, 1),
