...
static bool ts_lex(TSLexer *lexer, TSStateId state) {
  ...
  switch (state) {
    case 0:
      ...
      if (set_contains(sym_identifier_character_set_1, 685, lookahead)) ADVANCE(7);
      END_STATE();
    case 1:
    ...
    case 7:
      ...
      if (set_contains(sym_identifier_character_set_2, 800, lookahead)) ADVANCE(7);
      END_STATE();
    case 8:
...
static const uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [STATE(1)] = {
    ...
    [sym_array] = STATE(101),
    [sym_array_associative] = STATE(101),
    [sym_call] = STATE(101),
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [25] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_file_repeat1, 2, 0, 0), SHIFT_REPEAT(40),
  [28] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_file_repeat1, 2, 0, 0), SHIFT_REPEAT(19),
  [31] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_file_repeat1, 2, 0, 0), SHIFT_REPEAT(101),
  [34] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_file_repeat1, 2, 0, 0), SHIFT_REPEAT(112),
  [37] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_file_repeat1, 2, 0, 0), SHIFT_REPEAT(15),
  [40] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_file_repeat1, 2, 0, 0), SHIFT_REPEAT(2),
  ...
  [51] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_file_repeat1, 2, 0, 0), SHIFT_REPEAT(31),
  ...
  [62] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_call, 2, 0, 2),
  ...
  [88] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_if, 4, 0, 7),
  [90] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_if, 4, 0, 7),
  [92] = {.entry = {.count = 1, .reusable = false}}, SHIFT(24),
  [94] = {.entry = {.count = 1, .reusable = false}}, SHIFT(119),
  [96] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_if, 5, 0, 7),
  [98] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_if, 5, 0, 7),
  ...
  [106] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_if_repeat1, 2, 0, 0),
  [108] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_if_repeat1, 2, 0, 0), SHIFT_REPEAT(24),
  [111] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_if_repeat1, 2, 0, 0), SHIFT_REPEAT(29),
  [114] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_body, 2, 0, 0),
  [116] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_body, 2, 0, 0),
  [118] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_variable_repeat1, 2, 0, 4),
  [120] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_variable_repeat1, 2, 0, 4), SHIFT_REPEAT(117),
  [123] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_body, 3, 0, 0),
  [125] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_body, 3, 0, 0),
  [127] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_elif, 4, 0, 7),
  [129] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_elif, 4, 0, 7),
  [131] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_variable, 1, 0, 0),
  [133] = {.entry = {.count = 1, .reusable = false}}, SHIFT(117),
  [135] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_variable, 2, 0, 1),
  ...
  [141] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_else, 3, 0, 12),
  [143] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_else, 3, 0, 12),
  [145] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_if, 6, 0, 7),
  [147] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_if, 6, 0, 7),
  ...
  [155] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_variable_repeat1, 2, 0, 4), SHIFT_REPEAT(118),
  ...
  [168] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_array_associative, 5, 0, 9),
  [170] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_string, 2, 0, 0),
  [172] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_array_associative, 6, 0, 10),
  [174] = {.entry = {.count = 1, .reusable = true}}, SHIFT(111),
  [176] = {.entry = {.count = 2, .reusable = true}}, REDUCE(sym_array, 2, 0, 0), REDUCE(sym_array_associative, 2, 0, 0),
  [179] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_variable_repeat1, 2, 0, 4), SHIFT_REPEAT(111),
  ...
  [194] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_call, 3, 0, 5),
  [196] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_array_repeat1, 2, 0, 0),
  [198] = {.entry = {.count = 1, .reusable = true}}, SHIFT(94),
  [200] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_array_associative_repeat1, 4, 0, 9),
  [202] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_array_repeat1, 2, 0, 0), SHIFT_REPEAT(21),
  [205] = {.entry = {.count = 1, .reusable = true}}, SHIFT(73),
  [207] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_array_associative_repeat1, 2, 0, 11), SHIFT_REPEAT(109),
  [210] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_array_associative_repeat1, 2, 0, 11),
  ...
  [234] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_assignment, 4, 0, 8),
  [236] = {.entry = {.count = 1, .reusable = true}}, SHIFT(100),
  [238] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_assignment, 3, 0, 6),
