...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [73] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_call, 2, 0, 2),
  ...
  [103] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_if, 5, 0, 7),
  [105] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_if, 5, 0, 7),
  ...
  [113] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_if, 4, 0, 7),
  [115] = {.entry = {.count = 1, .reusable = false}}, SHIFT(22),
  [117] = {.entry = {.count = 1, .reusable = false}}, SHIFT(120),
  [119] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_if, 4, 0, 7),
  ...
  [147] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_elif, 4, 0, 7),
  [149] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_elif, 4, 0, 7),
  ...
  [163] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_else, 3, 0, 12),
  [165] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_else, 3, 0, 12),
  [167] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_if, 6, 0, 7),
  [169] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_if, 6, 0, 7),
  [171] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_variable, 2, 0, 1),
  ...
  [181] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_variable_repeat1, 2, 0, 4),
  [183] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_variable_repeat1, 2, 0, 4), SHIFT_REPEAT(119),
  [186] = {.entry = {.count = 1, .reusable = true}}, SHIFT(33),
  [188] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_variable_repeat1, 2, 0, 4), SHIFT_REPEAT(115),
  ...
  [197] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_variable_repeat1, 2, 0, 3),
  [199] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_array, 4, 0, 0),
  [201] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_call, 3, 0, 5),
  [203] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_array_associative, 6, 0, 10),
  [205] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_array, 3, 0, 0),
  [207] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_array_associative, 5, 0, 9),
  ...
  [225] = {.entry = {.count = 2, .reusable = true}}, REDUCE(sym_array, 2, 0, 0), REDUCE(sym_array_associative, 2, 0, 0),
  [228] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_array_associative_repeat1, 4, 0, 9),
  [230] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_array_repeat1, 2, 0, 0), SHIFT_REPEAT(29),
  [233] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_array_repeat1, 2, 0, 0),
  [235] = {.entry = {.count = 1, .reusable = true}}, SHIFT(89),
  [237] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_array_associative_repeat1, 2, 0, 11), SHIFT_REPEAT(124),
  [240] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_array_associative_repeat1, 2, 0, 11),
  ...
  [280] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_array_associative, 2, 0, 0),
