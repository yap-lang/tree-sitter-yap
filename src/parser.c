...
enum ts_symbol_identifiers {
  ...
  anon_sym_else = 5,
  anon_sym_while = 6,
  sym_literal_number = 7,
  anon_sym_DQUOTE = 8,
  sym_string_content = 9,
  sym_expression_unit = 10,
  anon_sym_LPAREN = 11,
  anon_sym_COMMA = 12,
  anon_sym_RPAREN = 13,
  sym_comment = 14,
  ...
  aux_sym_statement_if_repeat1 = 34,
  aux_sym_expression_array_repeat1 = 35,
  aux_sym_expression_array_associative_repeat1 = 36,
  aux_sym_name_repeat1 = 37,
};
...
static const char * const ts_symbol_names[] = {
  ...
  [sym_statement_while] = "statement_while",
...
static const TSSymbol ts_symbol_map[] = {
  ...
  [sym_statement_while] = sym_statement_while,
...
static const uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [STATE(1)] = {
    ...
    [sym_statement_while] = STATE(4),
    [sym__expression] = STATE(81),
    [sym_literal_string] = STATE(89),
    [sym_expression_array] = STATE(89),
    [sym_expression_array_associative] = STATE(89),
    [sym_expression_call] = STATE(89),
    [sym_name] = STATE(15),
  ...
  [STATE(2)] = {
    ...
    [sym_statement_if] = STATE(9),
    [sym_statement_while] = STATE(9),
  ...
  [STATE(5)] = {
    ...
    [sym_literal_number] = ACTIONS(40),
    [anon_sym_DQUOTE] = ACTIONS(43),
    [sym_expression_unit] = ACTIONS(40),
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [31] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_file_repeat1, 2, 0, 0), SHIFT_REPEAT(48),
  [34] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_file_repeat1, 2, 0, 0), SHIFT_REPEAT(31),
  [37] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_file_repeat1, 2, 0, 0), SHIFT_REPEAT(27),
  [40] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_file_repeat1, 2, 0, 0), SHIFT_REPEAT(89),
  [43] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_file_repeat1, 2, 0, 0), SHIFT_REPEAT(117),
  [46] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_file_repeat1, 2, 0, 0), SHIFT_REPEAT(29),
  [49] = {.entry = {.count = 1, .reusable = true}}, SHIFT(46),
  [51] = {.entry = {.count = 1, .reusable = true}}, SHIFT(43),
  [53] = {.entry = {.count = 1, .reusable = true}}, SHIFT(45),
  [55] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_file_repeat1, 2, 0, 0), SHIFT_REPEAT(34),
  [58] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_file_repeat1, 2, 0, 0), SHIFT_REPEAT(35),
  [61] = {.entry = {.count = 1, .reusable = true}}, SHIFT(42),
  [63] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_expression_call, 1, 0, 1),
  ...
  [75] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_expression_call, 2, 0, 3),
  [77] = {.entry = {.count = 1, .reusable = true}}, SHIFT(16),
  [79] = {.entry = {.count = 1, .reusable = true}}, SHIFT(48),
  [81] = {.entry = {.count = 1, .reusable = true}}, SHIFT(3),
  [83] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_statement_if, 4, 0, 9),
  [85] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_statement_if, 4, 0, 9),
  [87] = {.entry = {.count = 1, .reusable = false}}, SHIFT(26),
  [89] = {.entry = {.count = 1, .reusable = false}}, SHIFT(122),
  [91] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_statement_if, 5, 0, 9),
  [93] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_statement_if, 5, 0, 9),
  [95] = {.entry = {.count = 1, .reusable = false}}, SHIFT(37),
  [97] = {.entry = {.count = 1, .reusable = false}}, SHIFT(120),
  [99] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_statement_if_repeat1, 2, 0, 0),
  [101] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_statement_if_repeat1, 2, 0, 0), SHIFT_REPEAT(37),
  [104] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_statement_if_repeat1, 2, 0, 0),
  [106] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_statement_if_repeat1, 2, 0, 0), SHIFT_REPEAT(26),
  ...
  [117] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_statement_elif, 4, 0, 9),
  [119] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_statement_elif, 4, 0, 9),
  [121] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_name, 2, 0, 2),
  [123] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_name, 2, 0, 2),
  [125] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_name_repeat1, 2, 0, 6),
  [127] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_name_repeat1, 2, 0, 6),
  [129] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_name_repeat1, 2, 0, 6), SHIFT_REPEAT(114),
  [132] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_statements, 2, 0, 0),
  [134] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_statements, 2, 0, 0),
  [136] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_statements, 3, 0, 0),
  [138] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_statements, 3, 0, 0),
  [140] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_name_repeat1, 2, 0, 6), SHIFT_REPEAT(119),
  [143] = {.entry = {.count = 1, .reusable = false}}, SHIFT(119),
  [145] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_name_repeat1, 2, 0, 5),
  [147] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_name_repeat1, 2, 0, 5),
  [149] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_statement_while, 4, 0, 9),
  [151] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_statement_while, 4, 0, 9),
  [153] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__statement, 2, 0, 0),
  [155] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__statement, 2, 0, 0),
  [157] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_statement_if, 6, 0, 9),
  [159] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_statement_if, 6, 0, 9),
  [161] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_statement_else, 3, 0, 14),
  [163] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_statement_else, 3, 0, 14),
  [165] = {.entry = {.count = 1, .reusable = true}}, SHIFT(102),
  [167] = {.entry = {.count = 1, .reusable = true}}, SHIFT(85),
  [169] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_expression_call, 3, 0, 7),
  [171] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_expression_call, 2, 0, 4),
  ...
  [183] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_expression_array_associative, 5, 0, 11),
  [185] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_expression_array, 4, 0, 0),
  [187] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_expression_array_repeat1, 2, 0, 0),
  [189] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_expression_array_associative, 6, 0, 12),
  [191] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_literal_string, 3, 0, 0),
  [193] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__expression, 1, 0, 0),
  [195] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_expression_array, 3, 0, 0),
  [197] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_expression_array_associative_repeat1, 4, 0, 11),
  [199] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_assignment, 4, 0, 10),
  ...
  [211] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_expression_array_associative_repeat1, 2, 0, 13), SHIFT_REPEAT(102),
  [214] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_expression_array_associative_repeat1, 2, 0, 13),
  [216] = {.entry = {.count = 1, .reusable = true}}, SHIFT(53),
  [218] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_expression_array_repeat1, 2, 0, 0), SHIFT_REPEAT(36),
  [221] = {.entry = {.count = 1, .reusable = true}}, SHIFT(70),
  [223] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_assignment, 3, 0, 8),
