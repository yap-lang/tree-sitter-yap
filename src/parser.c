...
enum ts_symbol_identifiers {
  ...
  sym_expression_array = 26,
  sym_expression_array_associative = 27,
  sym_expression_call = 28,
  aux_sym_file_repeat1 = 29,
  aux_sym_statement_if_repeat1 = 30,
  aux_sym_variable_repeat1 = 31,
  aux_sym_expression_array_repeat1 = 32,
  aux_sym_expression_array_associative_repeat1 = 33,
};
...
static const char * const ts_symbol_names[] = {
  ...
  [sym_clause_elif] = "clause_elif",
  [sym_clause_else] = "clause_else",
...
static const TSSymbol ts_symbol_map[] = {
  ...
  [sym_clause_elif] = sym_clause_elif,
  [sym_clause_else] = sym_clause_else,
...
static const uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [STATE(1)] = {
    ...
    [sym_expression_array] = STATE(91),
    [sym_expression_array_associative] = STATE(91),
    [sym_expression_call] = STATE(91),
    [aux_sym_file_repeat1] = STATE(4),
    [ts_builtin_sym_end] = ACTIONS(5),
    [sym_identifier] = ACTIONS(7),
    [anon_sym_if] = ACTIONS(9),
    [sym_literal_number] = ACTIONS(11),
  ...
  [STATE(6)] = {
    ...
    [sym_literal_number] = ACTIONS(37),
    [anon_sym_DQUOTE] = ACTIONS(40),
    [anon_sym_LPAREN] = ACTIONS(43),
    [sym_comment] = ACTIONS(3),
    [sym__indent] = ACTIONS(46),
  },
  [STATE(7)] = {
    [sym_statements] = STATE(91),
    [sym__statement] = STATE(9),
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [31] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_file_repeat1, 2, 0, 0), SHIFT_REPEAT(34),
  [34] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_file_repeat1, 2, 0, 0), SHIFT_REPEAT(19),
  [37] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_file_repeat1, 2, 0, 0), SHIFT_REPEAT(91),
  [40] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_file_repeat1, 2, 0, 0), SHIFT_REPEAT(110),
  [43] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_file_repeat1, 2, 0, 0), SHIFT_REPEAT(16),
  [46] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_file_repeat1, 2, 0, 0), SHIFT_REPEAT(3),
  [49] = {.entry = {.count = 1, .reusable = true}}, SHIFT(35),
  [51] = {.entry = {.count = 1, .reusable = true}}, SHIFT(58),
  [53] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_file_repeat1, 2, 0, 0), SHIFT_REPEAT(30),
  [56] = {.entry = {.count = 1, .reusable = true}}, SHIFT(62),
  [58] = {.entry = {.count = 1, .reusable = true}}, SHIFT(39),
  [60] = {.entry = {.count = 1, .reusable = true}}, SHIFT(41),
  [62] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_expression_call, 2, 0, 2),
  ...
  [88] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_statement_if, 4, 0, 7),
  [90] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_statement_if, 4, 0, 7),
  [92] = {.entry = {.count = 1, .reusable = false}}, SHIFT(24),
  [94] = {.entry = {.count = 1, .reusable = false}}, SHIFT(120),
  [96] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_statement_if, 5, 0, 7),
  [98] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_statement_if, 5, 0, 7),
  ...
  [106] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_statement_if_repeat1, 2, 0, 0),
  [108] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_statement_if_repeat1, 2, 0, 0), SHIFT_REPEAT(24),
  [111] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_statement_if_repeat1, 2, 0, 0), SHIFT_REPEAT(31),
  [114] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_variable, 1, 0, 0),
  [116] = {.entry = {.count = 1, .reusable = false}}, SHIFT(117),
  [118] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_statements, 3, 0, 0),
  [120] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_statements, 3, 0, 0),
  [122] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_clause_elif, 4, 0, 7),
  [124] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_clause_elif, 4, 0, 7),
  [126] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_variable, 2, 0, 1),
  [128] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_statements, 2, 0, 0),
  [130] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_statements, 2, 0, 0),
  [132] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_variable_repeat1, 2, 0, 4),
  [134] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_variable_repeat1, 2, 0, 4), SHIFT_REPEAT(117),
  [137] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_variable_repeat1, 2, 0, 3),
  [139] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_variable_repeat1, 2, 0, 3),
  [141] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__statement, 2, 0, 0),
  [143] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__statement, 2, 0, 0),
  [145] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_statement_if, 6, 0, 7),
  [147] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_statement_if, 6, 0, 7),
  [149] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_clause_else, 3, 0, 12),
  [151] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_clause_else, 3, 0, 12),
  [153] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_variable_repeat1, 2, 0, 4), SHIFT_REPEAT(111),
  ...
  [168] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_literal_string, 2, 0, 0),
  [170] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_expression_array, 3, 0, 0),
  [172] = {.entry = {.count = 2, .reusable = true}}, REDUCE(sym_expression_array, 2, 0, 0), REDUCE(sym_expression_array_associative, 2, 0, 0),
  [175] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_expression_call, 3, 0, 5),
  [177] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_expression_array, 4, 0, 0),
  [179] = {.entry = {.count = 1, .reusable = true}}, SHIFT(109),
  [181] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_expression_array_associative, 6, 0, 10),
  [183] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_expression_array_associative, 5, 0, 9),
  [185] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_variable_repeat1, 2, 0, 4), SHIFT_REPEAT(109),
  ...
  [196] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_expression_array_repeat1, 2, 0, 0), SHIFT_REPEAT(21),
  [199] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_expression_array_repeat1, 2, 0, 0),
  [201] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_expression_array_associative_repeat1, 4, 0, 9),
  ...
  [209] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_expression_array_associative_repeat1, 2, 0, 11), SHIFT_REPEAT(113),
  [212] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_expression_array_associative_repeat1, 2, 0, 11),
  ...
  [222] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_assignment, 4, 0, 8),
  ...
  [234] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_assignment, 3, 0, 6),
