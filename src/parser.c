...
enum ts_symbol_identifiers {
  ...
  sym__statement = 22,
  sym_assignment = 23,
  sym_statement_return = 24,
  sym_statement_if = 25,
  sym_statement_elif = 26,
  sym_statement_else = 27,
  sym_statement_while = 28,
  sym__expression = 29,
  sym_literal_string = 30,
  sym_expression_array = 31,
  sym_expression_array_associative = 32,
  sym_expression_call = 33,
  sym_name = 34,
  aux_sym_file_repeat1 = 35,
  aux_sym_statement_if_repeat1 = 36,
  aux_sym_expression_array_repeat1 = 37,
  aux_sym_expression_array_associative_repeat1 = 38,
  aux_sym_name_repeat1 = 39,
};
...
static const uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [STATE(1)] = {
    ...
    [sym_statement_return] = STATE(122),
    [sym_statement_if] = STATE(10),
    [sym_statement_while] = STATE(10),
    [sym_name] = STATE(9),
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [15] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_expression_call, 1, 0, 2),
  ...
  [27] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_expression_call, 2, 0, 4),
  ...
  [47] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_file_repeat1, 2, 0, 0), SHIFT_REPEAT(39),
  [50] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_file_repeat1, 2, 0, 0), SHIFT_REPEAT(22),
  [53] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_file_repeat1, 2, 0, 0), SHIFT_REPEAT(21),
  ...
  [65] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_file_repeat1, 2, 0, 0), SHIFT_REPEAT(23),
  [68] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_file_repeat1, 2, 0, 0), SHIFT_REPEAT(30),
  ...
  [81] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_statement_if, 5, 0, 10),
  [83] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_statement_if, 5, 0, 10),
  [85] = {.entry = {.count = 1, .reusable = false}}, SHIFT(31),
  [87] = {.entry = {.count = 1, .reusable = false}}, SHIFT(113),
  [89] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_name_repeat1, 2, 0, 7),
  [91] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_name_repeat1, 2, 0, 7),
  [93] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_name_repeat1, 2, 0, 7), SHIFT_REPEAT(115),
  [96] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_name, 2, 0, 3),
  [98] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_name, 2, 0, 3),
  [100] = {.entry = {.count = 1, .reusable = false}}, SHIFT(115),
  [102] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_statement_if, 4, 0, 10),
  [104] = {.entry = {.count = 1, .reusable = false}}, SHIFT(32),
  [106] = {.entry = {.count = 1, .reusable = false}}, SHIFT(121),
  [108] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_statement_if, 4, 0, 10),
  [110] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_name, 1, 0, 0),
  [112] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_name, 1, 0, 0),
  [114] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_statement_if_repeat1, 2, 0, 0),
  [116] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_statement_if_repeat1, 2, 0, 0),
  [118] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_statement_if_repeat1, 2, 0, 0), SHIFT_REPEAT(31),
  [121] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_name_repeat1, 2, 0, 6),
  [123] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_name_repeat1, 2, 0, 6),
  [125] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_statement_if_repeat1, 2, 0, 0), SHIFT_REPEAT(32),
  [128] = {.entry = {.count = 1, .reusable = false}}, SHIFT(114),
  [130] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_name_repeat1, 2, 0, 7), SHIFT_REPEAT(114),
  [133] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_statement_elif, 4, 0, 10),
  [135] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_statement_elif, 4, 0, 10),
  [137] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_statements, 2, 0, 0),
  [139] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_statements, 2, 0, 0),
  [141] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_statements, 3, 0, 0),
  [143] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_statements, 3, 0, 0),
  [145] = {.entry = {.count = 1, .reusable = true}}, SHIFT(97),
  [147] = {.entry = {.count = 1, .reusable = true}}, SHIFT(73),
  [149] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_statement_while, 4, 0, 10),
  [151] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_statement_while, 4, 0, 10),
  [153] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_expression_call, 2, 0, 5),
  [155] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_expression_call, 3, 0, 9),
  [157] = {.entry = {.count = 1, .reusable = true}}, SHIFT(101),
  [159] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_statement_if, 6, 0, 10),
  [161] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_statement_if, 6, 0, 10),
  [163] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_statement_else, 3, 0, 15),
  [165] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_statement_else, 3, 0, 15),
  ...
  [177] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_literal_string, 3, 0, 0),
  [179] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_expression_array_repeat1, 2, 0, 0),
  [181] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_expression_array, 4, 0, 0),
  [183] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_expression_array, 3, 0, 0),
  [185] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_expression_array_associative, 5, 0, 12),
  [187] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_expression_array_associative, 6, 0, 13),
  [189] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_expression_array_associative_repeat1, 4, 0, 12),
  [191] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__expression, 1, 0, 0),
  [193] = {.entry = {.count = 1, .reusable = true}}, SHIFT(99),
  [195] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_expression_array_repeat1, 2, 0, 0), SHIFT_REPEAT(29),
  [198] = {.entry = {.count = 1, .reusable = true}}, SHIFT(71),
  [200] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_assignment, 3, 0, 8),
  [202] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_expression_array_associative_repeat1, 2, 0, 14), SHIFT_REPEAT(97),
  [205] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_expression_array_associative_repeat1, 2, 0, 14),
  [207] = {.entry = {.count = 1, .reusable = true}}, SHIFT(74),
  [209] = {.entry = {.count = 1, .reusable = true}}, SHIFT(7),
  [211] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_assignment, 4, 0, 11),
  [213] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_statement_return, 2, 0, 1),
