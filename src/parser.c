...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [33] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_abstraction, 3, 0, 3),
  ...
  [45] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_reference, 2, 0, 0),
  ...
  [53] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_reference_repeat1, 2, 0, 0),
  [55] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_reference_repeat1, 2, 0, 0), SHIFT_REPEAT(37),
  [58] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_reference_repeat1, 2, 0, 0), SHIFT_REPEAT(43),
  [61] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_reference_repeat1, 2, 0, 0),
  [63] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__expression_primary, 3, 0, 0),
  [65] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_record, 3, 0, 0),
  [67] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_record, 2, 0, 0),
  [69] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_application, 2, 0, 2),
  [71] = {.entry = {.count = 1, .reusable = true}}, SHIFT(38),
  [73] = {.entry = {.count = 1, .reusable = true}}, SHIFT(41),
  [75] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_record_repeat1, 2, 0, 0), SHIFT_REPEAT(38),
  [78] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_record_repeat1, 2, 0, 0),
  ...
  [90] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_record_field, 4, 0, 1),
