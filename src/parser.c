...
enum ts_symbol_identifiers {
  ...
  sym_source_file = 13,
  sym__expression = 14,
  sym__expression_primary = 15,
  sym_abstraction = 16,
  sym_application = 17,
  sym_reference = 18,
  sym_record = 19,
  sym_record_field = 20,
  aux_sym_reference_repeat1 = 21,
  aux_sym_record_repeat1 = 22,
};
...
static bool ts_lex(TSLexer *lexer, TSStateId state) {
  ...
  switch (state) {
    case 0:
      ...
      if (set_contains(sym_identifier_character_set_1, 685, lookahead)) ADVANCE(19);
      END_STATE();
    case 1:
    ...
    case 19:
      ...
      if (set_contains(sym_identifier_character_set_2, 800, lookahead)) ADVANCE(19);
      END_STATE();
    default:
      return false;
  }
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [33] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_abstraction, 3, 0, 5),
  ...
  [45] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_reference, 2, 0, 2),
  ...
  [53] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_reference_repeat1, 2, 0, 7),
  [55] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_reference_repeat1, 2, 0, 7), SHIFT_REPEAT(37),
  [58] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_reference_repeat1, 2, 0, 7), SHIFT_REPEAT(43),
  [61] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_reference_repeat1, 2, 0, 6),
  [63] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_reference_repeat1, 2, 0, 6),
  [65] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__expression_primary, 3, 0, 0),
  [67] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_record, 3, 0, 0),
  [69] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_record, 2, 0, 0),
  [71] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_application, 2, 0, 4),
  [73] = {.entry = {.count = 1, .reusable = true}}, SHIFT(38),
  [75] = {.entry = {.count = 1, .reusable = true}}, SHIFT(41),
  [77] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_record_repeat1, 2, 0, 0), SHIFT_REPEAT(38),
  [80] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_record_repeat1, 2, 0, 0),
  ...
  [92] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_record_field, 4, 0, 3),
