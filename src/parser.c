...
enum ts_symbol_identifiers {
  ...
  aux_sym_if_statement_repeat1 = 25,
};
...
static bool ts_lex(TSLexer *lexer, TSStateId state) {
  ...
  switch (state) {
    case 0:
      ...
      if (set_contains(sym_identifier_character_set_1, 685, lookahead)) ADVANCE(24);
      END_STATE();
    case 1:
    ...
    case 10:
      ...
      if (set_contains(sym_identifier_character_set_2, 800, lookahead)) ADVANCE(24);
      END_STATE();
    case 11:
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [27] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_file_repeat1, 2, 0, 0), SHIFT_REPEAT(33),
  [30] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_file_repeat1, 2, 0, 0), SHIFT_REPEAT(23),
  [33] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_file_repeat1, 2, 0, 0), SHIFT_REPEAT(49),
  [36] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_file_repeat1, 2, 0, 0), SHIFT_REPEAT(50),
  [39] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_file_repeat1, 2, 0, 0), SHIFT_REPEAT(81),
  [42] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_file_repeat1, 2, 0, 0), SHIFT_REPEAT(2),
  [45] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_file_repeat1, 2, 0, 0), SHIFT_REPEAT(35),
  ...
  [68] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_if_statement, 4, 0, 4),
  [70] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_if_statement, 4, 0, 4),
  [72] = {.entry = {.count = 1, .reusable = false}}, SHIFT(32),
  [74] = {.entry = {.count = 1, .reusable = false}}, SHIFT(74),
  [76] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_if_statement, 5, 0, 4),
  [78] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_if_statement, 5, 0, 4),
  [80] = {.entry = {.count = 1, .reusable = false}}, SHIFT(34),
  [82] = {.entry = {.count = 1, .reusable = false}}, SHIFT(80),
  [84] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_if_statement_repeat1, 2, 0, 0),
  [86] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_if_statement_repeat1, 2, 0, 0),
  [88] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_if_statement_repeat1, 2, 0, 0), SHIFT_REPEAT(32),
  [91] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_if_statement_repeat1, 2, 0, 0), SHIFT_REPEAT(34),
  [94] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_return_statement, 1, 0, 0),
  [96] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_elif_clause, 4, 0, 4),
  [98] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_elif_clause, 4, 0, 4),
  [100] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_call, 2, 0, 1),
  ...
  [116] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_else_clause, 3, 0, 5),
  [118] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_else_clause, 3, 0, 5),
  [120] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_if_statement, 6, 0, 4),
  [122] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_if_statement, 6, 0, 4),
  [124] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__statement, 2, 0, 0),
  ...
  [132] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_call, 3, 0, 3),
  ...
  [156] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_assign_statement, 3, 0, 2),
