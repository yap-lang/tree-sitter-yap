...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [43] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_abstraction, 3, 0, 6),
  ...
  [55] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_reference, 1, 0, 1),
  [57] = {.entry = {.count = 1, .reusable = false}}, SHIFT(43),
  [59] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_reference, 1, 0, 1),
  [61] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_reference, 2, 0, 2),
  [63] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_reference, 2, 0, 2),
  [65] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_reference, 2, 0, 3),
  [67] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_reference, 2, 0, 3),
  [69] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_reference, 3, 0, 7),
  [71] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_reference, 3, 0, 7),
  [73] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_reference_repeat1, 2, 0, 8),
  [75] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_reference_repeat1, 2, 0, 8), SHIFT_REPEAT(43),
  [78] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_reference_repeat1, 2, 0, 8),
  [80] = {.entry = {.count = 1, .reusable = false}}, SHIFT(47),
  [82] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_reference_repeat1, 2, 0, 8), SHIFT_REPEAT(47),
  [85] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_reference_repeat1, 2, 0, 2),
  [87] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_reference_repeat1, 2, 0, 2),
  [89] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_record, 2, 0, 0),
  [91] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_record, 2, 0, 0),
  [93] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_application, 2, 0, 5),
  [95] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_application, 2, 0, 5),
  ...
  [101] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_record, 3, 0, 0),
  [103] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_record, 3, 0, 0),
  [105] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_root_repeat1, 2, 0, 0), SHIFT_REPEAT(51),
  [108] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_root_repeat1, 2, 0, 0),
  [110] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_root_repeat1, 2, 0, 0), SHIFT_REPEAT(44),
  [113] = {.entry = {.count = 1, .reusable = true}}, SHIFT(51),
  [115] = {.entry = {.count = 1, .reusable = true}}, SHIFT(26),
  [117] = {.entry = {.count = 1, .reusable = true}}, SHIFT(33),
  [119] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_root, 1, 0, 0),
  [121] = {.entry = {.count = 1, .reusable = true}}, SHIFT(29),
  [123] = {.entry = {.count = 1, .reusable = true}}, SHIFT(30),
  [125] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_record_field, 4, 0, 4),
